...
const menuItems = [
  ...
  },
  {
    ...
    label: 'Agent 平台',
    children: [
      { key: '/providers', icon: <ApiOutlined />, label: '模型供应商', disabled: true },
      { key: '/model-mgmt', icon: <BlockOutlined />, label: '模型管理', disabled: true },
      { key: '/prompts', icon: <FileTextOutlined />, label: 'Prompt 管理', disabled: true },
      { key: '/knowledge', icon: <DatabaseOutlined />, label: '知识库管理', disabled: true },
      { key: '/tools', icon: <ToolOutlined />, label: '工具管理', disabled: true },
